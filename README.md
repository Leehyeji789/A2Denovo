...
- RepeatMasker annotation BED
- Segmental duplication BED
- Low-complexity region BED
- Tandem repeat BED
- Homopolymer region BED
- GIAB difficult region BED
- gnomAD Hail Table (optional, for population frequency filtering)
